...
/**
  ...
  */
  ...
  #define MACRO_TOOL_WEAK   __attribute__((weak))
  
#elif defined(__ICCARM__) || defined(__ICC8051__)
  #define MACRO_TOOL_WEAK __weak
  
#else
  // Symbols for Doxygen
  #define MACRO_TOOL_WEAK
 ...
 */
  ...
  #define MACRO_UNUSED_VARIABLE(VARIABLE) \
    do                                    \
    {                                     \
      if (&VARIABLE == NULL)              \
      {                                   \
